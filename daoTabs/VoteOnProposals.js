  ...
  useEffect(() => {
    const get_all_proposals = async () => {
      try {
        ...
        console.log("voter token is", amountOfVoterTokens);
            ...
            {all_props.map((element, index) =>
              index % 3 === i ? (
                ...
                >
                  ...
                  <br />
                  <label className="h6" style={{ fontStyle: "italic" }}>
                    Voting Power: {element[index][3]}
                  </label>
                  <br />
                      ...
                      <div className="col-8 col-sm-9">
                        <div className="input-group mb-3">
                          ...
                          <input
                            ...
                            id="html"
                            name="fav_language"
                            value={currAmountOfVotes[index][indx2]}
                          />
                          <div className="input-group-append">
                            <button
                              type="button"
                        ...
                        <div className="input-group mb-3">
                          ...
                          <div className="input-group-append">
                            <button
                              ...
                              disabled={
                                element[index][5] === true ||
                                weights[index] === amountOfVoterTokens ||
                                amountOfVoterTokens <= 0
                              }
                              onClick={() => {
                                let selCopy = [...weights];
                  ...
                  <br />
                  <button
                    disabled={element[index][5] || amountOfVoterTokens <= 0}
                    type="button"
