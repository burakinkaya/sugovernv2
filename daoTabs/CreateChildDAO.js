    ...
    <div className="container border border-black p-4">
      ...
      <form>
        <div className="form-group">
          <label htmlFor="exampleInputDAOName" className="text-dark">
            DAO Name
          </label>
          <input
            type="name"
        ...
        <br />
        <div className="form-group">
          <label htmlFor="exampleInputDAODesc" className="text-dark">
            DAO Description
          </label>
          <textarea
            type="name"
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            id="exampleInputEmail1"
            aria-describedby="emailHelp"
            placeholder="Enter DAO image"
          />
        </div>
        <br />
        <div className="form-group">
          <label htmlFor="exampleInputYKName" className="text-dark">
            YK Token Name
          </label>
          <input
            type="name"
        ...
        <br />
        <div className="form-group">
          <label htmlFor="exampleInputYKSymbol" className="text-dark">
            YK Token Symbol
          </label>
          <input
            type="name"
        ...
        <br />
        <div className="form-group">
          <label htmlFor="exampleInputVTName" className="text-dark">
            Voter Token Name
          </label>
          <input
            type="name"
        ...
        <br />
        <div className="form-group">
          <label htmlFor="exampleInputVTSymbol" className="text-dark">
            Voter Token Symbol
          </label>
          <input
            type="name"
            onChange={(e) => {
              {
                daoInfo.current = {
                  ...daoInfo.current,
                  voterTokenSymbol: e.target.value,
                };
              }
            }}
            className="form-control"
